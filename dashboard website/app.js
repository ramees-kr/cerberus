var data = [
  {
    url: "blablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablablabla.com",
    status: "Unblocked",
  },
  {
    url: "blablabla.com",
...
for (var i = 0; i < data.length; i++) {
  ...
  if (data[i].status === "Blocked") {
    ...
    blockedCount++; // Increment the blocked count
  } else {
